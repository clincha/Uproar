...
<head>
    <#--not needed if using the nav bar-->
...
<div class="mainblock">
    ...
    <h2>This is the bio about the society that they can then fill in themselves, we can give them several lines to do
        this so ... </h2>
    <br>
    <h1>Events</h1>
    <div class="wrapper">
        <div class="card1">
            <div class="card" style="width: 25rem;"><a href="Placeholder">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Here we will need the bio of the event, can just have event name, time place
                        society etc</p>
                </div>
            </div>
        </div>
