        ...
        <nav>
            ...
            <div class="container">
                <div class="text-center">
                    <h1 class="display-1"><strong>What Is The Uproar About</strong></h1>
                    <p class="lead"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque praesentium tempora
                        suscipit asperiores ab?</p>
                </div>
                <br/>
